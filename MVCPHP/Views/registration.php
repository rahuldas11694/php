...
<hr id="line">
     <form action="registration.php" action="" id="reg-form">  <!-- this is for signup.php  -->
		<div class="d">
			<label class="reg-label">Employee Name:</label>  <input type="username" placeholder="Name" name="EmployeeName" class="empName wid"  /><br>
 
			<label class="reg-label">Employee Id:</label>  <input type="empId" name="password" placeholder="Your Id" class="empId wid " name="empId" /><br>

		   <label class="reg-label">password:</label>  <input type="password" name="password" placeholder="eg-@urhf873&*HS" class="empId wid" name="password"/><br>
 

 			<label class="reg-label">Date of Birth: </label> <input type="date of birth" name="dob" placeholder="D.O.B" class="DOB wid" name="DOB" /><br>
